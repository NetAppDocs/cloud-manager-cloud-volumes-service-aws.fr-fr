$(document).ready(function () {
  try {
    ...
    let baseUrlSection = "/fr-fr/cloud-manager-cloud-volumes-service-aws/pdfs/";
    ...
    zipFilename = zipFilename !== ''?zipFilename:"cloud-manager-cloud-volumes-service-aws.fr-fr.zip";
